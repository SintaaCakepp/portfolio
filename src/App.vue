...
const whatsappNumber = '62881037363537'
...
function sendViaWhatsapp() {
  const { name, contact, message } = contactForm.value

  const text =
    `Hi Cyntaa, this is ${name}.\n` +
    `Contact: ${contact}\n\n` +
    `${message}`
  ...
  contactForm.value = { name: '', contact: '', message: '' }
}

/* =========================
   SCROLL SPY + REVEAL + BACK TO TOP
========================== */
  ...
  <i class="fa-solid fa-user"></i>
    ...
    >
      ...
      <form
        ...
        @submit.prevent="sendViaWhatsapp"
      >
        ...
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            placeholder="you@email.com or +62 8xx-xxxx-xxxx"
            required
          />
        </div>
